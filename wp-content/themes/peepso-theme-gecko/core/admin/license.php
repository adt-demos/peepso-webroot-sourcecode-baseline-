...
if (!class_exists('Gecko_Theme_License')) {
    ...
    class Gecko_Theme_License
    {
        ...
        const THEME_VERSION = '6.4.3.0'; // keep single spaces here, I need them for search.replace - Matt
        ...
        public static function submenu_page_callback()
        {
            ...
            if ($valid) {
                if (isset($license['expire']) && $license['expire']) {
                    ...
                    if ($expires == 'lifetime') {
                        $color = '#689f38';
                        $message = sprintf(__('Valid for a %s', 'peepso-theme-gecko'), $expires);
                ...
                <div class="gca-dash">
                    <div class="gca-dash__inner">
                        <div class="gca-dash__header">
                            <div class="gca-dash__logo"><img
                                    src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gecko.png"
                                    alt="Gecko" /></div>

                            <div class="gca-dash__title">
                                <?php esc_html_e('License', 'peepso-theme-gecko'); ?>
                            </div>

                            <div class="gca-dash__actions">
                                <input type="hidden" name="gecko-config-nonce"
                                    value="<?php echo wp_create_nonce('gecko-config-nonce') ?>" />
                                <?php submit_button(); ?>
                            </div>
                        </div>
                        ...
                        <div class="gca-dash__main">
                            <div class="gca-dash__sidebar">
                                <div class="gca-dash__menu">
                                    <a href="admin.php?page=gecko-settings" class="gca-dash__menu-link"><i
                                            class="gcis gci-tools"></i>
                                        <?php esc_html_e('Settings', 'peepso-theme-gecko'); ?>
                                    </a>
                                    <a href="admin.php?page=gecko-customizer" class="gca-dash__menu-link"><i
                                            class="gcis gci-swatchbook"></i>
                                        <?php esc_html_e('Gecko Customizer', 'peepso-theme-gecko'); ?>
                                    </a>
                                    <a href="admin.php?page=gecko-page-builders" class="gca-dash__menu-link"><i
                                            class="gcis gci-file-alt"></i>
                                        <?php esc_html_e('Page Builders', 'peepso-theme-gecko'); ?>
                                    </a>
                                    <?php if (!isset($_SERVER['HTTP_HOST']) || 'demo.peepso.com' != $_SERVER['HTTP_HOST']) { ?>
                                        <a href="admin.php?page=gecko-license"
                                            class="gca-dash__menu-link gca-dash__menu-link--active"><i class="gcis gci-key"></i>
                                            <?php esc_html_e('License', 'peepso-theme-gecko'); ?>
                                        </a>
                                    <?php } ?>
                                </div>
                            ...
                            <div class="gca-dash__content">
                                <div class="gca-dash__settings">
                                    ...
                                    <div class="gca-dash__settings-group">
                                        <div class="gca-dash__settings-name"><i class="gcis gci-key"></i>
                                            <?php esc_html_e('License', 'peepso-theme-gecko'); ?>
                                        </div>
                                        ...
                                        <div class="gca-dash__options gca-dash__options--single">
                                            ...
                                            <div class="gca-dash__option">
                                                <div class="gca-dash__option-name">
                                                    <?php esc_html_e('License key', 'peepso-theme-gecko'); ?>
                                                </div>
                                                <?php
                                                $gecko_settings = GeckoConfigSettings::get_instance();
                                                $value = $gecko_settings->get_option('gecko_license');
                                                ?>
                                                <input type="text" name="gecko_options[gecko_license]" id="gecko_license"
                                                    value="<?php echo esc_attr($value); ?>">
                                                <div class="gca-dash__option-desc">
                                                    <p><i class="gcis gci-info-circle"></i>
                                                        <?php echo $details; ?>
                                                    </p>
                                                </div>
                                            </div>
                                ...
                                <div class="gca-dash__foot">
                                    <div class="gca-dash__ver">
                                        <?php esc_html_e('Version', 'peepso-theme-gecko'); ?>:
                                        <?php echo wp_get_theme()->version ?>
                                    </div>
                                    <div class="gca-dash__actions">
                                        <input type="hidden" name="gecko-config-nonce"
                                            value="<?php echo wp_create_nonce('gecko-config-nonce') ?>" />
        ...
        public static function activate_license($theme_slug, $theme_edd)
        {
            ...
            if (!is_object($validation_data)) {
                ...
                if (!empty(self::_get_transient('peepso_is_offline'))) {
        ...
        public static function is_valid_key($plugin)
        {
            ...
            if (isset($data['expire']) && $data['expire'] == 'lifetime') {
                return (TRUE);
            }
        ...
        public static function check_updates($theme_edd, $theme_slug, $theme_version, $file, $is_core = TRUE)
        {
            ...
            if (empty($version)) {
                ...
                $peepso_is_offline = FALSE;
                if (!empty(self::_get_transient($trans_peepso_is_offline))) {
                    $peepso_is_offline = TRUE;
                }
